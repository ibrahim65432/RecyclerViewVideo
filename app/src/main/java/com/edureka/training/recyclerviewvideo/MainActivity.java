package com.edureka.training.recyclerviewvideo;
...
public class MainActivity extends AppCompatActivity implements PersonAdapter.ItemClicked{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        people.add(new Person("People", "Jennings", "plane"));
        people.add(new Person("Tom", "Cruise", "plane"));
        people.add(new Person("John", "Rambo", "bus"));
        people.add(new Person("Chuck", "Norris", "bus"));
        people.add(new Person("People", "Jennings", "plane"));
        people.add(new Person("Tom", "Cruise", "plane"));        people.add(new Person("John", "Rambo", "bus"));
        people.add(new Person("Chuck", "Norris", "bus"));
        people.add(new Person("People", "Jennings", "plane"));
        people.add(new Person("Tom", "Cruise", "plane"));
